...
function Card({title,price,rate, image} : CardProps) {
    ...
    return (
      <>
       ...
       className=" flex flex-col items-center p-6 max-w-sm  rounded overflow-hidden shadow-inner bg-white h-[500px]  hover:shadow-2xl transition duration-300 ease-in-out transform hover:-translate-y-1 group">
